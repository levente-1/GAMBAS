...
parser.add_argument("--data_path", type=str, default='/media/hdd/levibaljer/Hype/train')
...
train_gen = NiftiDataSet(args.data_path, which_direction='AtoB', transforms=trainTransforms, shuffle_labels=True, train=True)
