...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument("--image", type=str, default='/media/hdd/levibaljer/GAMBAS/figureNew/T2_AXIWarped.nii.gz')
        parser.add_argument("--result", type=str, default='/media/hdd/levibaljer/GAMBAS/figureNew/T2_GAMBAS.nii.gz', help='path to the .nii result to save')
