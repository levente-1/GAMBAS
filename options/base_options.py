...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--data_path', type=str, default='/path/to/train/images', help='Train images path (paired)')
        parser.add_argument('--val_path', type=str, default='/path/to/val/images', help='Validation images path')
