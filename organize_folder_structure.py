...
# Just sort files in a human order (i.e. 10 after 9, not after 1)
...
parser.add_argument('--images', default='./Data_folder/LF', help='path to the images a (early frames)')
parser.add_argument('--labels', default='./Data_folder/HF', help='path to the images b (late frames)')
...
if __name__ == "__main__":
    ...
    for i in range(len(list_images)-int(args.split)):
        ...
        save_directory_images = os.path.join(data_dir, 'train', 'images')
        save_directory_labels = os.path.join(data_dir, 'train', 'labels')
    ...
    for i in range(int(args.split)):
        ...
        save_directory_images = os.path.join(data_dir, 'test', 'images')
        save_directory_labels = os.path.join(data_dir, 'test', 'labels')
