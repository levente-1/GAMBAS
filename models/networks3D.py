...
def get_scheduler(optimizer, opt):
    ...
    elif opt.lr_policy == 'identity':
        def identity_rule(epoch):
            lr_l = 1.0
            return lr_l
        scheduler = lr_scheduler.LambdaLR(optimizer, lr_lambda=identity_rule)
...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[], **kwargs):
    net = None
